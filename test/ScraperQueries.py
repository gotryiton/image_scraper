...
class ScraperQueries:
    def __init__(self):
        ...
        self.expected_results = (
            {'title': 'ASOS Block Colour Cagoule', 'image': 'http://images.asos.com/inv/media/7/7/8/9/1919877/blue/image1xl.jpg', 'description': None},
    ...
    def get_response(self, url):
        ...
        urllib.request.Request(self.scraper_url, )
