...
var expectedResponses = [
  ...
  {'title': '7 For All Mankind Cropped Skinny Jeans | SHOPBOP', 'image': 'http://g-ecx.images-amazon.com/images/G/01/Shopbop/p/pcs/products/seven/seven4015611318/seven4015611318_p4_1-0_254x500.jpg', 'description': '7 For All Mankind Cropped Skinny Jeans at SHOPBOP.COM - FASTEST FREE SHIPPING WORLDWIDE. Buy 7 For All Mankind Online'},
  {'title': 'FADED GREY TROUSERS - Jeans - Woman - ZARA United States', 'image': 'http://static.zara.net/photos//2012/V/0/1/p/6045/042/804/6045042804_1_1_3.jpg?timestamp=1328289461558', 'description': 'FADED GREY TROUSERS'},
  {'title': 'DKNY \'Sunny Escape\' Leggings | Nordstrom', 'image': 'http://g-lvl3.nordstromimage.com/ImageGallery/store/product/Medium/9/_6821389.jpg', 'description': 'DKNY \'Sunny Escape\' Leggings | Nordstrom'},
  {'title': 'Large Gold Hammered Teardrop Earrings by Kenneth Jay Lane | Charm & Chain', 'image': 'http://cdn.shopify.com/s/files/1/0019/0222/products/IMG_0126_medium.jpg?106717', 'description': 'Large Gold Hammered Teardrop Earrings: There’s...'}
];
...
exports['test-mobile-sites'] = function(test) {
  ...
  sites.forEach(function(site, index) {
    ...
    sc.getData(function(data) {
      ...
      test.equals(data['description'], expectedResponse['description']);
      count--;
      if (count == 0) {
        test.done();
      }
